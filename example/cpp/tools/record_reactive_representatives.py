...
SPECS = [
    {"id": "impact_strong_recovery", "title": "IMPACT | PHYSICAL PUSH -> AUTO EMERGENCY STOP", "subtitle": "0.80 m/s MuJoCo push | detector -> 0.50 s transition -> WBC stance hold", "controller_duration": 16.0, "raw_duration": 17.0, "clip_start": 2.0, "clip_duration": 15.0, "fallback": [(4.7, 5.2, "PHYSICAL IMPACT", "red"), (5.2, 7.5, "EMERGENCY STOP", "red")], "args": ["--reactive-events", "--impact-to-emergency-stop-delay", "0.5", "--push-time", "8.0", "--push-vel-x", "0.8", "--push-duration", "0.2"]},
