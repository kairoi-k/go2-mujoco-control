...
Generated: 2026-08-20T02:32:15+08:00
...
- Controller duration: 7.5 s; post window: 1.5 s
- Event source: scheduled scripts only (automatic sensor events enabled: False)
- Infrastructure policy: up to 2 attempts with 5.0 s cooldown and alternate DDS domains
