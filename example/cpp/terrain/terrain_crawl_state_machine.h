...
public:
    ...
    // Full-v2 moving SHIFT keeps the legacy weight; lip avoidance belongs in
    // foothold placement rather than this stance objective.
    static constexpr double kV2FullShiftStanceNoSlipWeight = 80.0;
