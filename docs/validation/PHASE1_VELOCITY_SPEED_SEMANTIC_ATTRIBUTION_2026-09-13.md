...
按每个 run×平台的 median 计，24 个重复平台中 21 个 measured 更接近 stance `step/P`；每个 1.4、2.3、2.8 平台均为 3/3 重复一致。0.6 平台为 0/3 stance 更近，反而更接近 planner 语义。因此 A 不是全速度域支持，而是除最低平台外的稳定模式。
...
| 项目 | 结论 | 证据强度 | 判断 |
|---|---|---|---|
| A. measured 更接近 step/period | **PARTIALLY SUPPORTED** | 中高 | 21/24 run×平台支持，0.6 平台反例；不能写成全域成立。 |
