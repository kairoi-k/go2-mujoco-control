...
- Physical obstacle: scene `scene_reactive_obstacle.xml`; `obstacle_left` detected at 5.040 s, latency 0.040 s after warmup, lateral shift 0.423 m, contact count/force 0/0.
