...
| Document | Purpose |
|---|---|
| [`RESEARCH_INDEX.md`](RESEARCH_INDEX.md) | canonical result, evidence scope, and frozen milestone |
| [`RESEARCH_HISTORY.md`](RESEARCH_HISTORY.md) | neutral milestone history and bounded interpretations |
