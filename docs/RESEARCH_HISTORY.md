...
| 2026-09-06 | B1 H5 force-backed support-anchor canary | not accepted | Clean source `324bd5d6f36d856f4bd5f9f75390855fb9abb251` | Planner replacement was proven (`target_prepared=54`, 198 execution plan IDs, `b3_plan_replacement=true`), but the correct-scene no-debug canary retained 541 required-plan rejection rows, 220 execution rows without WBC plan, and stopped at 18.83 s on cycle-quality rejection. First support witness was knot 0 mask 9 at 0.014376 m, below the frozen 0.015 m. Evidence: `example/cpp/experiments/_runs/phase2_b1_development_canary_h5_force_anchor_20260906_023000`; no B1 claim. |

| 2026-09-06 | B1 H6 planner-to-MPC absolute-time horizon consistency | not accepted | 1f6adc1723b744265e74af17318dad4ee6f2ede9 | Added non-clamping absolute-time knot lookup, MPC sample-time mapping, explicit horizon telemetry, and focused regression coverage. Focused CTest 4/4 and production build passed; fixed-3-m/s B0 development pair passed at the two retained baseline and terrain run directories. The same-SHA B1 canary retained 1,434 required rejections, 811 execution rows without WBC plan, 84 collisions, and a cycle-quality stop. No contract, threshold, contact, COM, or acceptance-semantic change. |
| 2026-09-06 | B1 H7 planner-execution consistency offline/shadow repair | diagnostic only; not accepted | ff937da old-defect witness; 8c02c2a contract tests; 338fe1ceee0c7b5c094c79081fe9493334db56dc integration | Old code failed the targeted overrun witness; new focused CTest is 5/5 PASS and real_trot_go2 builds. The env-gated shadow path defaults off and no B1 run was made. Read-only flat evidence is example/cpp/experiments/_runs/phase2_h7_offline_support_margin_20260906_338fe1c: unchanged 15 mm criterion, base 12,005/18,615 PASS, model COM 12,803/18,615 PASS, four-contact subset 3,072/3,072 for both. H5 foothold coordinates remain missing; dynamic two-contact rows are diagnostic only. No threshold, contract, or acceptance-semantic change. |
| 2026-09-06 | H8 offline replay and Atlas terrain-sensor-only shadow validation | diagnostic complete; B1 not accepted | d550fb36aaee877b31f451c72fe6beec3d8b5fd2 | Final flat shadow-on replay: 6,653 rows / 1,820 complete snapshots / 283 explicit rejects; 5 cm approach: 4,443 / 1,890 / 406; same-tick COM had zero mismatches. Shadow-off/on command invariance was not proven because repeated lockstep runs had different first ticks and baseline output variation. Same-SHA fixed-3-m/s B0 pair passed. No terrain actuation, B1 holdout, threshold, contract, or acceptance-semantic change. |

| 2026-09-06 | H8 shadow rejection decomposition and readiness classification | diagnostic; B1 not accepted | Clean source `e6253fd0940724042d682fccc35b7cbaf1d89774` | Readiness now separates invalid/expired plan from horizon coverage; focused and full 33/33 CTest plus real_trot_go2 passed. Fresh terrain-sensor-only shadow runs `phase2_h8_shadow_fixed_e6253fd_flat_lockstep` and `phase2_h8_shadow_fixed_e6253fd_step5cm_lockstep` have code4=0 and zero same-tick COM mismatches, but stable unchecked rows remain 5,730/5,877 and target/event mismatches 15/14. Historical d550 code4=283/406 is decomposed by stage, plan/epoch, phase, leg commitment state in CURRENT.md. Exact-source fixed-3-m/s B0 pair passed; command invariance replay infrastructure is still absent. No terrain actuation, B1 canary/holdout, threshold, contract, or semantic change. |
| 2026-09-06 | H9 H8 stable no-plan lifecycle attribution | diagnostic complete; Stage-C handoff; B1 not accepted | Analysis head 39c6fbf12858088d7f496cf05b72c1820f23c10e; evidence manifests at clean source e6253fd0940724042d682fccc35b7cbaf1d89774 | Flat/5-cm stable no-plan rows 5,629/5,776 are 100% direct consumer misses after plan expiry; terrain map/model COM were ready, planner updates continued, and no deadline was recorded. Latest planner rejection distribution is support-infeasible 4,105/4,209 (72.9%) and no-safe-foothold 1,524/1,567 (27.1%). Per-leg candidate and support-knot/mask telemetry is missing. Stop old planner repair and hand off joint foothold plus COM/body trajectory; no contract, threshold, semantic, actuation, or B1 change. |

| 2026-09-06 | Stage-C C0-01/C0-02 foundation preparation | diagnostic/unit evidence; B0/B1 not accepted | `feat/stage-c-joint-planner` -> `0e09535c43d4fd26be3de387f02752a43115fa0f` | Real repository fixture `test_stage_c_foundations` passes 1/1 and covers T01-T07/T13-T15, including the legacy anchor asymmetry witness, safe-region degeneration, coverage taxonomy, event/coverage/commitment semantics, frozen transfer conflict, and reference-span meaning. Typed Stage C input/event/candidate/failure/rollout/bundle interfaces plus deterministic exhaustive search/oracle are present; no continuous solver, control-path integration, terrain actuation, B1, threshold, or analyzer change. Available CTest is 30/30 PASS; the MuJoCo-dependent integration/build target is blocked by the absent checkout dependency. Evidence: [`stage_c_c0_foundations`](research/evidence/stage_c_c0_foundations/README.md). |
...
| 2026-09-06 | B1 H5 force-anchor canary | not accepted | `324bd5d6f36d856f4bd5f9f75390855fb9abb251` | Force-backed measured-contact support anchors did not clear the frozen 1.5 cm support gate: 541 required rejection rows, 220 execution rows without WBC plan, no collision rows, and cycle-quality stop at 18.83 s. Planner-selected targets entered execution; evidence retained under `example/cpp/experiments/_runs/phase2_b1_development_canary_h5_force_anchor_20260906_023000`. |
